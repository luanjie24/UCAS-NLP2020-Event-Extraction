    ...
    def json_list_extract_event(json_list: list,
        ...
        for one_corpus in json_list:
            ...
            for one_event in one_corpus_events:
                ...
                one_event = Event(tokenizer,
                                  one_corpus_sentences,
                                  one_trigger,
                                  cur_arguments[object_key],
                                  cur_arguments[subject_key],
                                  cur_arguments[time_key],
                                  cur_arguments[location_key],
                                  sentence_length)
...
if __name__ == "__main__":
    ...
    # 拆分数据
    raw_data_path = '../dataset/xf_2020_Corpus/final/EE2020/dev.json'
